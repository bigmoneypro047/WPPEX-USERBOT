...
PROMO_TOPICS = {
    "copy_vs_job": [
        "Copy trading benar-benar mengubah hidup saya. Tidak ada lagi stres kerja 9-5",
        "Saya berhenti dari pekerjaan 9-5 saya 3 bulan lalu dan tidak pernah menyesal 💪",
        "Tidak ada bos, tidak ada perjalanan kerja. Cukup ikuti sinyal profesor dan hasilkan uang",
        "Bekerja dari rumah mengalahkan pekerjaan kantor mana pun yang pernah saya miliki 📊",
        "Siapa lagi yang menghasilkan uang di sini sementara orang lain masih terjebak macet pagi-pagi haha",
        "Penghasilan saya lebih stabil sejak copy trading dibandingkan gaji mana pun sebelumnya",
        "Sistem kerja 9-5 tidak pernah dirancang untuk kebebasan finansial yang nyata. Itu fakta 🔥",
        "Copy trading memberi Anda waktu DAN uang. Itulah impian yang sesungguhnya 🙌",
        "Gaya hidup saya berubah total sejak saya berhenti bergantung pada gaji 📈",
        "Bayangkan mendapatkan bayaran saat tidur. Itulah yang terjadi di sini",
        "Dulu saya bekerja 12 jam sehari untuk orang lain. Sekarang saya bekerja untuk diri sendiri",
        "Copy trading dari QT adalah perubahan karir terbaik yang pernah saya lakukan 🎯",
    ],
    "crypto_market": [
        "Pasar kripto terlihat sangat kuat saat ini 🚀",
        "Likuiditas sangat tinggi hari ini. Kondisi sempurna untuk trading",
        "Ketika likuiditas kuat, sinyal bekerja lebih baik lagi 🎯",
        "Harga kripto bergerak dengan indah minggu ini",
        "Waktu masuk pasar profesor selalu tepat dalam kondisi apapun. Ini bukan kebetulan 🙌",
        "Pasar kripto tidak pernah tidur dan begitu juga penghasilan kita 💰",
        "Volatilitas bagus hari ini. Sinyal bekerja sangat baik",
        "Kripto naik lagi. Berada di grup yang tepat memang sangat penting 🚀",
        "Pasar bergerak sesuai keinginan kita hari ini. Profesor menebaknya dengan sempurna",
        "Lilin hijau di mana-mana. Inilah alasan kita bertahan di grup ini 🔥",
        "Bitcoin bergerak bagus hari ini. Kondisi sinyal sempurna",
        "Momentum pasar kuat. Profesor selalu menempatkan kita di posisi terdepan 💪",
    ],
    "qt_opportunity": [
        "Bergabung dengan QT Investment Group adalah keputusan finansial terbaik yang pernah saya buat",
        "Peluang di grup ini muncul secara konsisten setiap hari tanpa gagal 📈",
        "Profesor tidak pernah absen sehari pun. Selalu hadir dan siap untuk kita",
        "QT berbeda dari grup mana pun yang pernah saya coba. Hasil nyata terbukti 🔥",
        "Komunitas ini benar-benar ingin setiap anggota sukses dan berkembang 🙏",
        "QT membuka mata saya tentang apa yang benar-benar mungkin dicapai",
        "Konsistensi di sini adalah yang membuat saya kembali setiap hari 📊",
        "Kalau kamu belum di QT Investment Group, jujur kamu sedang ketinggalan sesuatu yang besar",
        "QT telah menunjukkan kepada saya bahwa kebebasan finansial bukan mimpi. Itu rencana 🎯",
        "Grup ini mengubah arah keuangan saya sepenuhnya 🙌",
        "Saya telah mereferensikan 5 orang ke QT dan semuanya sekarang berterima kasih",
        "Anggota baru bergabung setiap minggu. Kabar ini menyebar dengan cepat 🔥",
    ],
    "referrals": [
        "Apakah ada yang sudah memanfaatkan hadiah referral di sini?",
        "Saya membawa 3 orang bulan lalu dan bonus referral itu benar-benar nyata 💰",
        "Referral memberi Anda penghasilan tambahan di atas keuntungan trading harian",
        "Semakin banyak orang yang Anda bawa ke QT, semakin banyak manfaat untuk semua 🙏",
        "Beritahu teman Anda. Anda juga mendapat penghasilan dari aktivitas copy trading mereka 💪",
        "Penghasilan referral adalah penghasilan pasif yang menumpuk di atas penghasilan pasif. Dua lapis",
        "Saya berbagi QT dengan semua orang yang saya kenal. Hadiah referral saja sudah sepadan 💰",
        "Bawa jaringan Anda dan mulai bangun penghasilan residual dari referral",
        "Setiap orang yang Anda referensikan menambahkan aliran penghasilan baru untuk Anda 💯",
        "Bonus referral saya bulan ini menutupi tagihan telepon dan data saya. Haha ini nyata 😂",
        "Cara paling mudah menghasilkan tambahan. Cukup bagikan QT kepada yang ingin berkembang secara finansial",
    ],
    "team_building": [
        "Membangun tim di dalam QT adalah cara tercepat untuk meningkatkan penghasilan Anda 💰",
        "Ketika tim Anda menyalin perdagangan, Anda juga mendapat manfaat dari volume trading mereka",
        "Pembentukan tim adalah cara para penghasil besar di sini melipatgandakan penghasilan dengan cepat 🔥",
        "Penghasilan sendiri itu bagus tapi penghasilan tim adalah level yang sama sekali berbeda",
        "Semakin banyak orang di tim Anda, semakin banyak aliran penghasilan yang Anda kendalikan 📊",
        "Tim Anda bekerja dan kalian semua menghasilkan bersama. Penghasilan yang berlipat ganda 💯",
        "Tim kami tumbuh setiap minggu dan penghasilan semua orang terus meningkat",
        "Kerja tim adalah jalur tercepat menuju pertumbuhan finansial nyata di sini 💪",
        "Saya mulai hanya dengan 2 orang di tim saya. Sekarang kami semua menghasilkan secara konsisten 🎯",
        "Setiap anggota tim baru menambah lebih banyak volume dan penghasilan untuk semua",
    ],
    "stable_income": [
        "Copy trading memberikan penghasilan harian yang stabil. Mengalahkan gaji bulanan mana pun 📊",
        "Pasar buka 24 jam 7 hari seminggu dan sinyal datang setiap hari tanpa henti",
        "Dengan akurasi profesor, hasilnya sangat konsisten dan dapat diandalkan sepenuhnya 🙏",
        "Tidak seperti pekerjaan biasa, penghasilan ini tidak bergantung pada majikan atau bos mana pun",
        "Penghasilan harian yang stabil tanpa harus melapor kepada siapa pun. Itulah kebebasan sejati 🏠",
        "Penghasilan bulanan saya dari copy trading sekarang melebihi gaji lama saya",
        "Konsisten. Dapat diandalkan. Stabil. Itulah yang diberikan QT copy trading setiap hari 🎯",
        "Profesor memberi sinyal di pasar yang naik maupun turun. Penghasilan mengalir dari kedua arah 🔥",
        "Saya tidak pernah melewatkan satu bulan yang menguntungkan sejak bergabung dengan QT 💰",
        "Ini adalah penghasilan paling konsisten yang pernah saya miliki. Serius",
    ],
    "forex_trading": [
        "Pasar forex bergerak sangat baik hari ini. Likuiditas sangat bagus 📈",
        "Profesor mencakup kripto DAN forex. Peluang penghasilan ganda setiap hari",
        "Dua pasar, dua aliran penghasilan, satu grup. Itulah nilai yang sesungguhnya 🔥",
        "Sinyal forex di sini sama tajamnya dengan sinyal kripto. Benar-benar mengesankan",
        "Setelah Anda memahami sinyalnya, forex menjadi sangat mudah untuk diikuti 📊",
        "Forex dan kripto bersama berarti penghasilan tidak peduli pasar mana yang aktif 💰",
        "Profesor membaca kedua pasar dengan sempurna. Itu keahlian yang langka",
        "Pasangan forex bergerak bagus hari ini bersama kripto. Sesi yang sangat menjanjikan 📈",
        "Fakta bahwa kita mendapatkan sinyal forex dan kripto setiap hari sungguh luar biasa 💪",
    ],
    "simplicity": [
        "Yang paling saya sukai dari copy trading adalah betapa mudah dan sederhananya",
        "Anda tidak perlu grafik atau pengetahuan teknis sama sekali. Cukup ikuti profesor 📱",
        "Lihat sinyal, salin perdagangan, tunggu keuntungan. Sesederhana itu",
        "Bahkan pemula total pun bisa menghasilkan di sini. Sinyal melakukan semua pekerjaan 🙌",
        "Saya tidak punya pengalaman trading sama sekali saat bergabung. Sekarang saya menghasilkan setiap hari 💰",
        "Kurva pembelajaran di sini benar-benar nol. Lihat sinyal, salin, hasilkan",
        "Siapa pun bisa melakukan ini. Muda, tua, tidak perlu pengalaman sama sekali 🙏",
        "Saya tunjukkan cara kerjanya ke sepupu saya minggu lalu. Dia sudah menghasilkan. Dia kaget sendiri 😂",
        "Ini sumber penghasilan termudah yang pernah saya temukan. Dan saya sudah coba banyak",
        "Anda tidak perlu memahami pasar. Profesor yang melakukannya untuk Anda 🎯",
    ],
    "home_income": [
        "Menghasilkan dari rumah tanpa bos masih terasa seperti mimpi yang jadi kenyataan bagi saya",
        "Copy trading memungkinkan Anda bekerja sesuai syarat dan jadwal Anda sendiri 📊",
        "Dulu saya berkomuter 2 jam setiap hari. Sekarang waktu itu menghasilkan uang untuk saya",
        "QT Investment Group memberi saya perspektif yang sama sekali baru tentang penghasilan 🙌",
        "Ponsel saya adalah kantor saya dan sinyal profesor adalah pekerjaan harian saya 📱",
        "Kebebasan finansial bukan mimpi ketika Anda berada di komunitas yang tepat",
        "Saya bekerja lebih sedikit dan menghasilkan lebih banyak sejak saya mulai copy trading di sini 💯",
        "Lokasi tidak masalah. Saya telah menghasilkan dari mana pun saya bepergian 🌍",
        "Di rumah, saat liburan, di mana saja. Penghasilan mengikuti Anda dengan copy trading",
    ],
    "fun_banter": [
        "Ada yang lain yang langsung cek HP begitu bangun pagi untuk lihat profit masuk semalam? Atau cuma aku haha",
        "Bos lamaku nelpon nanya apa aku mau balik kerja. Aku ketawa sampai ngakak hampir jatuh HP-nya 😂",
        "Aku bilang ke mama sekarang kerja dari HP. Dia masih tidak percaya. Sudah aku kirim screenshot profitnya",
        "Teman-teman kantorku masih makan siang sedih di meja kerja, aku makan enak di rumah 😂🍽️",
        "Tau tanda kalau hidup sudah berhasil? Bangun jam 10 pagi hari Selasa dan masih dapat uang",
        "Alarm pagi sekarang jadi pilihan bukan keharusan. Perasaan terbaik di dunia 😂🙌",
        "Teman tanya aku kerja apa. Aku bilang ikutin profesor. Dia menatapku seperti orang aneh. Ya sudahlah haha",
        "Pas kamu sadar grup chat ini lebih produktif dari kantor lamamu 😂📈",
        "Tidak ada yang ngalahin aku jam 3 pagi ngecek apakah sinyal sudah keluar. Kebiasaan baru 👀",
        "Ceritain kalau kamu copy trading tanpa bilang langsung. Aku mulai: aku batalkan Netflix dan investasikan lagi",
        "HP-ku sekarang lebih banyak aplikasi trading daripada media sosial. Bukan masalah 😂",
        "Bayangkan masih lembur gaji tetap padahal bisa ada di sini. Bukan menyindir tapi ya",
    ],
    "daily_life": [
        "Selamat pagi semua. Semoga tidurnya nyenyak dan siap untuk hari yang bagus lagi 🌅",
        "Ada yang lagi ngopi sekarang? Tidak bisa kerja sebelum secangkir pertama ☕",
        "Hujan di sini tapi mood tetap bagus. Hari bagus tidak perlu sinar matahari kalau chart hijau",
        "Pada ngapain hari ini? Aku lagi kerja dari sofa. Hidup impian haha",
        "Pengingat bahwa konsistensi mengalahkan segalanya. Hadir setiap hari dan hasilnya akan ikut",
        "Baru saja makan enak dan tidak perlu mikir dua kali soal harganya. Itulah kebebasan 🍽️",
        "Akhir pekan tetap terasa bagus kalau tahu penghasilan tetap masuk 😊",
        "Satu hal yang aku suka dari grup ini. Semua orang benar-benar saling mendukung. Hal yang langka",
        "Mulai hari dengan rasa syukur. Bersyukur untuk profesor, untuk QT, untuk komunitas ini 🙏",
        "Hidup terlalu singkat untuk dihabiskan stres soal uang. Temukan sistemmu dan biarkan bekerja",
        "Salut buat semua yang berani ambil keputusan dan bergabung. Keputusan terbaik yang pernah dibuat 🙌",
        "Ada hari lambat ada hari cepat. Bagaimanapun kita tetap konsisten dan percaya prosesnya",
    ],
    "trading_humor": [
        "POV: kamu menjelaskan copy trading ke anggota keluarga untuk ke-5 kalinya. Percaya aku saja bro",
        "Pasar turun dan aku literally tidak peduli karena profesor sudah cover kita semua 😂🙌",
        "Aku sebelum QT: nonton tutorial YouTube 6 bulan. Aku setelah QT: tinggal ikutin sinyal",
        "Manajemen risiko katanya. Diversifikasi katanya. Atau biarkan profesor yang handle 😂",
        "Hari hijau mood bagus. Hari merah masih mood bagus karena profesor sudah tahu duluan",
        "Twitter kripto lagi panik. Sementara kita tinggal nunggu sinyal begini 😌",
        "Lelucon paling lucu adalah mikir kamu bisa trading lebih baik dari profesor secara manual. Dengan hormat",
        "Setiap kali lihat berita kripto crash aku langsung buka grup dan lihat kita baik-baik saja 😂",
        "Orang-orang menghabiskan berjam-jam baca chart padahal bisa tinggal copy profesional. Tidak masuk akal",
        "Portfolio-ku dulu seperti film horor. Sekarang seperti kisah sukses 😂📈",
        "Perbedaan antara aku 6 bulan lalu dan sekarang adalah satu grup, satu profesor, satu keputusan",
    ],
}
