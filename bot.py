...
PROMO_TOPICS = {
    "copy_vs_job": [
        ...
        "Siapa lagi yang menghasilkan uang di sini sementara orang lain terjebak macet? 😂",
        "Penghasilan saya lebih stabil sejak copy trading dibandingkan gaji mana pun sebelumnya 💯",
        "Sistem kerja 9-5 tidak pernah dirancang untuk kebebasan finansial yang nyata 🔥",
    ...
    "crypto_market": [
        ...
        "Waktu masuk pasar profesor selalu tepat dalam kondisi apapun 🙌",
        "Pasar kripto tidak pernah tidur dan begitu juga penghasilan kita 💰",
        "Volatilitas bagus hari ini — sinyal bekerja sangat baik 🎯",
        "Kripto naik lagi — berada di grup yang tepat sangat penting 🚀",
    ...
    "qt_opportunity": [
        ...
        "Jika Anda tidak ada di QT Investment Group, Anda sedang melewatkan sesuatu yang besar 🚀",
        "QT telah menunjukkan kepada saya bahwa kebebasan finansial bukan mimpi — itu adalah rencana 🎯",
    ...
    "referrals": [
        ...
        "Penghasilan referral adalah penghasilan pasif yang menumpuk di atas penghasilan pasif 🔥",
        ...
        "Bonus referral saya bulan ini menutupi tagihan telepon dan data saya 😂💰",
        "Cara mudah menghasilkan tambahan — cukup bagikan QT kepada yang ingin berkembang secara finansial 📊",
    ],
    "team_building": [
        ...
        "Ini adalah penghasilan yang berlipat ganda — tim Anda bekerja dan kalian semua menghasilkan bersama 💯",
    ...
    "stable_income": [
        "Copy trading memberikan penghasilan harian yang stabil dan mengalahkan gaji bulanan mana pun 📊",
        ...
        "Ini adalah penghasilan paling konsisten yang pernah saya miliki dalam hidup saya 💯",
    ],
    "forex_trading": [
        ...
        "Profesor membaca kedua pasar dengan sempurna — itu adalah keahlian yang langka dan sangat berharga 🙌",
    ...
    "simplicity": [
        ...
        "Saya menunjukkan cara kerjanya kepada sepupu saya minggu lalu dan dia sudah menghasilkan keuntungan 😂",
        "Ini adalah sumber penghasilan termudah yang pernah saya temukan — dan saya sudah mencoba banyak 💯",
        "Anda tidak perlu memahami pasar — profesor yang melakukannya untuk Anda 🎯",
    ],
    "home_income": [
        "Menghasilkan dari rumah tanpa bos masih terasa seperti mimpi yang menjadi kenyataan bagi saya 🏠💰",
    ...
    "fun_banter": [
        "Ada yang lain yang langsung cek HP begitu bangun pagi untuk lihat profit masuk semalam? 😂 atau cuma aku?",
        "Bos lamaku nelpon nanya apa aku mau balik kerja. Aku sampai ketawa ngakak hampir jatuh HP-nya 😂💀",
        "Aku bilang ke mama sekarang kerja dari HP. Dia masih tidak percaya 😂 udah aku kirim screenshot profitnya",
        "Teman-teman kantorku masih makan siang sedih di meja kerja, aku makan enak di rumah 😂🍽️",
        "Tau kalau hidup sudah berhasil kalau bangun jam 10 pagi hari Selasa dan masih dapat uang 😂💰",
        "Alarm pagi sekarang jadi pilihan bukan keharusan. Perasaan terbaik di dunia 😂🙌",
        "Teman tanya aku kerja apa. Aku bilang ikutin profesor. Dia menatapku seperti orang aneh 😂",
        "Pas kamu sadar grup chat ini lebih produktif dari kantor lamamu 😂📈",
        "Tidak ada yang ngalahin:\nAku jam 3 pagi: ngecek apakah sinyal sudah keluar 😂👀",
        "Ceritain kalau kamu copy trading tanpa bilang langsung. Aku mulai: aku batalkan Netflix dan investasikan lagi 😂",
        "HP-ku sekarang lebih banyak aplikasi trading daripada media sosial. Perkembangan. 😂📊",
        "Bayangkan masih lembur gaji tetap padahal bisa ada di sini 😂 bukan menyindir ya",
    ],
    "daily_life": [
        "Selamat pagi semua! Semoga tidurnya nyenyak dan siap untuk hari yang bagus lagi 🌅",
        "Ada yang lagi ngopi sekarang? Tidak bisa bekerja sebelum secangkir pertama ☕😂",
        "Hujan di sini tapi mood tetap bagus — hari bagus tidak perlu sinar matahari kalau chart hijau 😊📈",
        "Pada ngapain hari ini? Aku lagi kerja dari sofa 😂 hidup impian",
        ...
        "Energy akhir pekan terasa berbeda kalau tahu penghasilan tetap masuk 😊💰",
    ...
    "trading_humor": [
        "POV: kamu menjelaskan copy trading ke anggota keluarga untuk ke-5 kalinya 😂 percaya aku saja",
        ...
        "Orang-orang menghabiskan berjam-jam baca chart padahal bisa tinggal copy profesional 😂",
